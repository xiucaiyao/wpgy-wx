...
<html>
	...
	<body>
		<script type='text/javascript' src='${pageContext.request.contextPath}/js/mobile/zepto.min.js' charset='utf-8'></script>
					...
					<div id="main">
						<div class="success">
							<p>
								...
								<p class="mt20">
									您的订单号：YN88393993
									<br />如果查看订单后续进度，请点击<a href="./orderList.html">订单列表</a>
									<br />
								</p>
							</p>
						</div>
